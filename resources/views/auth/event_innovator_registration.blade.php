        ...
        <div class="col-md-6  register">
            <div class="card box-shadow">
                ...
                <div class="card-header bg-white access">
                    <h3><i class="fa fa-book"></i> Participate As <span class="register_as">A Innovator</span></h3>
                ...
                <div class="card-body">
                    ...
                    <div class="Innovator">
                        ...
                        <form action="{{route('loginWithSchoialMedia', 'facebook')}}" class="SocialForm" method="POST">
                            ...
                            <div class="form-group row">
                                <label class="col-md-4">OR </label>
                                <div class="col-md-8">
                                    <input type="hidden" name="user_type" class="fblog" value="Innovator">
                    ...
                    <div class="form-group row Innovator dflex">
                        <label class="col-md-4"></label>
                        <div class="col-md-5">
...
$(document).on("click", ".user_res", function(){
    var ts = $(this);
    var uType = "Innovator";//$("input[name=RegisterAs]:checked").val();
            ...
            if(rsp.error == false){
               console.log(rsp.data.usertype);
                ...
                setTimeout(function(){
                   ...
                   else if(rsp.data['type'] == 'Innovator'){
                    $(".sErr").html("<div class='alert alert-danger'>Please First Update Your Profile</div>");
