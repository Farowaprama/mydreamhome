...
<div class="wrapper">
  ...
  <!-- Preloader -->
   ...
   <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <a href="<?php echo e(url('logout')); ?>"  class="nav-link text-red"><i class="fa fa-power-off"></i></a>
    </ul>
  ...
  <!-- /.navbar -->
       ...
       <?php /**PATH C:\laragon\www\mydreamhome\resources\views/admin/layout/header.blade.php ENDPATH**/ ?>