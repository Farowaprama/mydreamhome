        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"> <a class="btn btn-success" href="javascript:void(0)" id="createNewProduct"> Create New Renter</a></li>
            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Renter List</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <table class="table table-bordered data-table display nowrap responsive" cellspacing='0' width='100%' id="renter_list">
                      ...
                      <div class="row">
                        <div class="col-md-12 col-md-12">
                          <div class="form-group">
                            <label>Enter Flat <span style="color:red">*<span></label>
                            <select class="form-control" name="flat_id" id="flat_id" placeholder="Enter Flat" data-dropdown-css-class="select2-purple" style="width: 100%;">
                              <option selected="selected" value="">Enter Flat </option>
                            ...
                            <span class="text-danger error-text flat_id_error"></span>
                          </div>
                          <!-- /.form-group -->
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="productForm_payBill" name="productForm" class="form-horizontal">
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail1">House Rent paid</label>
                      ...
                      <div class="form-group" id="gas_bill_hide">
                        <label for="exampleInputEmail1">Gas Bill paid</label>
                      ...
                      <div class="form-group" id="water_bill_hide">
                        <label for="exampleInputEmail1">Water Bill paid</label>
                      ...
                      <div class="form-group" id="garbage_bill_hide">
                        <label for="exampleInputEmail1">Garbage Bill paid</label>
...
function ajaxApprove(id, the, action) {
  ...
  alert(id);
        ...
        $.ajax({
            ...
            url: '<?php echo e(url('/user-approve-or-delete')); ?>',
            type: 'post',
            data: {
            id: id,
            type: action
            ...
            beforeSend: function(){
                $(the).removeClass("btn-danger").addClass("btn-warning").html("<i class='fa fa-spinner fa-spin'></i>");
            },
                ...
                if(response.status==1){
                  location.reload();
                   ...
                   // });
                    ...
                    $(the).removeClass("btn-warning").addClass("btn-danger").html("Unsuccessfull!");
                }
              }
        });
}
...
$(document).ready(function(){
  ...
  $(function () {
    ...
    var table = $('.data-table').DataTable({
        ...
        ajax: "<?php echo e(route('products-ajax-crud.index')); ?>",

        columns: [

            {data: 'DT_RowIndex', name: 'DT_RowIndex'},
            {data: 'flat_no', name: 'Flat No'},
            {data: 'total_bill', name: 'Total Rent'},
...
$.ajax({
  ...
  error: function (data) {
    ...
    $('body').on('click', '.editProduct', function () {
      ...
      $.get("<?php echo e(route('products-ajax-crud.index')); ?>" +'/' + user_id +'/edit', function (data) {

          $('#modelHeading').html("Edit Renter");
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mydreamhome\resources\views/productAjax.blade.php ENDPATH**/ ?>