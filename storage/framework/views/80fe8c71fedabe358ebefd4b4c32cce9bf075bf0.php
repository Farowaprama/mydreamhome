        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"> <a class="btn btn-success" href="<?php echo e(url('pay_bill_list')); ?>" id="createNewProduct"> Pay Bill List</a></li>
                      ...
                      <div class="row">
                        <div class="col-md-12 col-md-12">
                          <div class="form-group">
                            ...
                            <span class="text-danger error-text pay_year_error"></span>
                          </div>
                          <!-- /.form-group -->
                        </div>
...
$(document).ready(function(){
  ...
  $(function () {
    ...
    var table = $('.data-table').DataTable({
        ...
        ajax: "<?php echo e(route('billing_history.index')); ?>",
    ...
    --------------------------------------------
    --------------------------------------------*/
    // $('body').on('click', '.dueBill', function () {

    //   var user_id = $(this).data('id');

    //   $.get("<?php echo e(url('due_bill_list')); ?>" +'/' + user_id , function (data) {

    //     console.log(data);

    //       $('#modelHeading_dueBill').html("Due Bill");

    //       //$('#saveBtn').val("edit-user");

    //       $('#ajaxModel_dueBill').modal('show');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mydreamhome\resources\views/billing_history.blade.php ENDPATH**/ ?>