        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"> <a class="btn btn-success text-white" href="<?php echo e(route('admin_role.create')); ?>">Add New User</a></li>
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-success text-white" href="<?php echo e(route('admin_role.edit', $user->id)); ?>">Edit</a>
                                        <?php endif; ?>
                                        <?php if(Auth::guard('web')->user()->can('role.delete') && $role->name !='superadmin' ): ?>
                                        <a class="btn btn-danger text-white" href="<?php echo e(route('admin_role.destroy', $user->id)); ?>"
                                        onclick="event.preventDefault(); document.getElementById('delete-form-<?php echo e($user->id); ?>').submit();">
                                            Delete
                                        </a>
                                        <?php endif; ?>

                                        <form id="delete-form-<?php echo e($user->id); ?>" action="<?php echo e(route('admin_role.destroy', $user->id)); ?>" method="POST" style="display: none;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\mydreamhome\resources\views/admin/index.blade.php ENDPATH**/ ?>